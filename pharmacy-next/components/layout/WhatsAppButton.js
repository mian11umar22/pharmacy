...
const WhatsAppButton = () => {
    ...
    return (
        <a
            ...
            className={`fixed ${isActionBarPage ? 'bottom-[70px]' : 'bottom-[75px]'} md:bottom-8 right-6 z-[99] flex items-center bg-transparent md:bg-white md:p-2 md:pr-5 rounded-full md:shadow-2xl md:border md:border-border hover:translate-y-[-4px] transition-all group active:scale-95 animate-fade-in`}
        >
